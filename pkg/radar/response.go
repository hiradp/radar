...
// analyzeResponse is the DTO for the /analyze endpoint.
// For more information, check https://github.com/ssllabs/ssllabs-scan/blob/stable/ssllabs-api-docs.md#host
